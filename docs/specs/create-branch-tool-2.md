...
file-mutating tools (`MUTATING_NATIVE`, `svarog/tool-budget-hook.ts:32-38`). A same-commit
...
`stribog/tool-budget-hook.ts:36-52`). This edits only the *message* of a denial, never its
